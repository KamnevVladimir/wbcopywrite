...
struct MessageFormatter {
    ...
    static func feedbackRatingPrompt() -> String {
        """
        💬 *Оцени бота*
        
        Как тебе работа с ботом?
        Оцени от 0 до 9, где:
        
        0️⃣ — очень плохо
        9️⃣ — отлично
        
        Твоё мнение поможет нам стать лучше! 🙏
        """
    }
    
    static func feedbackCommentPrompt(rating: Int) -> String {
        let emoji: String
        switch rating {
        case 0...3:
            emoji = "😔"
        ...
        return """
        \(emoji) Спасибо за оценку *\(rating)*!
        
        Хочешь добавить комментарий?
        Напиши, что можно улучшить или что тебе понравилось.
        
        Или нажми "Пропустить" 👇
        """
    }
    
    static func feedbackThankYou(rating: Int) -> String {
        let message: String
        switch rating {
        case 0...3:
            message = "Спасибо за честный отзыв! 😔\nМы обязательно учтём твои замечания и станем лучше."
        case 4...6:
            message = "Спасибо за отзыв! 🤔\nРаботаем над улучшениями."
        case 7...9:
            message = "Спасибо за высокую оценку! 😊\nМы продолжим развиваться!"
        default:
            message = "Спасибо за отзыв! 🙏"
        }
        ...
        Используй /menu чтобы продолжить работу.
        """
    }
}
